...
while (conditional)
{
	Console.Write("You won't see this");
}
...
//The for loop takes these three parts and, seperated by semicolons, we define them right in the parenthesis after the word for.
for (int i = 0; i < 10; i++)
{
	Console.Write(i+", ");
}
